...
func (s *Service) GetTomcats(ctx gtype.Context, ps gtype.Params) {
	results := make([]*model.ServiceTomcatInfo, 0)
	...
	if s.cfg != nil {
		...
		for i := 0; i < c; i++ {
			...
			result := &model.ServiceTomcatInfo{
				Name:        item.Name,
...
func (s *Service) GetTomcatsDoc(doc gtype.Doc, method string, uri gtype.Uri) {
	...
	function.SetOutputDataExample([]*model.ServiceTomcatInfo{
		{
			Name:        "example",
			ServiceName: "tomcat",
		},
...
func (s *Service) GetTomcatApps(ctx gtype.Context, ps gtype.Params) {
	...
	results := make([]*model.ServiceTomcatApp, 0)
	folder := info.WebApp
	if len(folder) > 0 {
...
func (s *Service) GetTomcatAppsDoc(doc gtype.Doc, method string, uri gtype.Uri) {
	...
	function.SetOutputDataExample([]*model.ServiceTomcatApp{
		{
			Name:       "example",
			Version:    "1.0.1.0",
...
func (s *Service) ModTomcatApp(ctx gtype.Context, ps gtype.Params) {
	...
	go s.writeOptMessage(socket.WSTomcatAppUpdated, argument)
...
func (s *Service) ModTomcatAppDoc(doc gtype.Doc, method string, uri gtype.Uri) {
	...
	function.SetOutputDataExample(&model.ServiceTomcatArgument{
		Name: "example",
		App:  "api",
	})
	function.AddOutputError(gtype.ErrTokenEmpty)
...
func (s *Service) DelTomcatApp(ctx gtype.Context, ps gtype.Params) {
	...
	go s.writeOptMessage(socket.WSTomcatAppDeleted, argument)
...
func (s *Service) GetTomcatConfigsDoc(doc gtype.Doc, method string, uri gtype.Uri) {
	...
	function.SetOutputDataExample([]*model.ServiceTomcatCfg{
		{
			Name:     "example",
			Path:     base64.URLEncoding.EncodeToString([]byte("example")),
			Children: []*model.ServiceTomcatCfg{},
		},
	})
	function.AddOutputError(gtype.ErrTokenEmpty)
	function.AddOutputError(gtype.ErrTokenInvalid)
...
func (s *Service) ModTomcatConfig(ctx gtype.Context, ps gtype.Params) {
	...
	go s.writeOptMessage(socket.WSTomcatCfgUpdated, argument)
...
func (s *Service) CreateTomcatConfigFolder(ctx gtype.Context, ps gtype.Params) {
	...
	go s.writeOptMessage(socket.WSTomcatCfgUpdated, args)
...
func (s *Service) DeleteTomcatConfig(ctx gtype.Context, ps gtype.Params) {
	...
	go s.writeOptMessage(socket.WSTomcatCfgDeleted, args)
...
func (s *Service) getTomcatCfg(cfg *model.ServiceTomcatCfg, root, folder string) {
	if cfg == nil {
		return
	}
	if cfg.Children == nil {
		cfg.Children = make([]*model.ServiceTomcatCfg, 0)
	}
...
func (s *Service) getTomcatLog(cfg *model.ServiceLogFile, root, folder string) {
	if cfg == nil {
		return
	}
	if cfg.Children == nil {
		cfg.Children = make([]*model.ServiceLogFile, 0)
	}
